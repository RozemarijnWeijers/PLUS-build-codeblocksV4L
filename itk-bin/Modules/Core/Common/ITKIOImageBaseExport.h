...
#  define ITKIOIMAGEBASE_DEPRECATED_EXPORT ITKIOImageBase_EXPORT __attribute__ ((__deprecated__))
#  define ITKIOIMAGEBASE_DEPRECATED_NO_EXPORT ITKIOImageBase_HIDDEN __attribute__ ((__deprecated__))
#endif
