...
#  define ITKIONRRD_DEPRECATED_EXPORT ITKIONRRD_EXPORT __attribute__ ((__deprecated__))
#  define ITKIONRRD_DEPRECATED_NO_EXPORT ITKIONRRD_HIDDEN __attribute__ ((__deprecated__))
#endif
