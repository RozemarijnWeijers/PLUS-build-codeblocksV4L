...
#  define ITKIOTIFF_DEPRECATED_EXPORT ITKIOTIFF_EXPORT __attribute__ ((__deprecated__))
#  define ITKIOTIFF_DEPRECATED_NO_EXPORT ITKIOTIFF_HIDDEN __attribute__ ((__deprecated__))
#endif
