...
#  define ITKCOMMON_DEPRECATED_EXPORT ITKCommon_EXPORT __attribute__ ((__deprecated__))
#  define ITKCOMMON_DEPRECATED_NO_EXPORT ITKCommon_HIDDEN __attribute__ ((__deprecated__))
#endif
