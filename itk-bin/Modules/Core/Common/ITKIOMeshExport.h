...
#  define ITKIOMESH_DEPRECATED_EXPORT ITKIOMesh_EXPORT __attribute__ ((__deprecated__))
#  define ITKIOMESH_DEPRECATED_NO_EXPORT ITKIOMesh_HIDDEN __attribute__ ((__deprecated__))
#endif
