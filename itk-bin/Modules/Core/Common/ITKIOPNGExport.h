...
#  define ITKIOPNG_DEPRECATED_EXPORT ITKIOPNG_EXPORT __attribute__ ((__deprecated__))
#  define ITKIOPNG_DEPRECATED_NO_EXPORT ITKIOPNG_HIDDEN __attribute__ ((__deprecated__))
#endif
