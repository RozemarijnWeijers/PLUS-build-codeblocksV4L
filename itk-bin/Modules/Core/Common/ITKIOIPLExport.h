...
#  define ITKIOIPL_DEPRECATED_EXPORT ITKIOIPL_EXPORT __attribute__ ((__deprecated__))
#  define ITKIOIPL_DEPRECATED_NO_EXPORT ITKIOIPL_HIDDEN __attribute__ ((__deprecated__))
#endif
