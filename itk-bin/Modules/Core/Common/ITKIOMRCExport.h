...
#  define ITKIOMRC_DEPRECATED_EXPORT ITKIOMRC_EXPORT __attribute__ ((__deprecated__))
#  define ITKIOMRC_DEPRECATED_NO_EXPORT ITKIOMRC_HIDDEN __attribute__ ((__deprecated__))
#endif
