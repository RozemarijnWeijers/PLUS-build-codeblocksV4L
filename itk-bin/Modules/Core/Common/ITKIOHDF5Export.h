...
#  define ITKIOHDF5_DEPRECATED_EXPORT ITKIOHDF5_EXPORT __attribute__ ((__deprecated__))
#  define ITKIOHDF5_DEPRECATED_NO_EXPORT ITKIOHDF5_HIDDEN __attribute__ ((__deprecated__))
#endif
