...
#  define ITKIOMETA_DEPRECATED_EXPORT ITKIOMeta_EXPORT __attribute__ ((__deprecated__))
#  define ITKIOMETA_DEPRECATED_NO_EXPORT ITKIOMeta_HIDDEN __attribute__ ((__deprecated__))
#endif
