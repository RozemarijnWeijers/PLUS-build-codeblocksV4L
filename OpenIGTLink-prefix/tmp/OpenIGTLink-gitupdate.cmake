...
execute_process(
  COMMAND "/usr/bin/git" show-ref 849b434b4b45a28e3955adf4ba1f3ececd51581e
  WORKING_DIRECTORY "/home/snr/Support/Plus-build-codeblocks/OpenIGTLink"
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 849b434b4b45a28e3955adf4ba1f3ececd51581e
  WORKING_DIRECTORY "/home/snr/Support/Plus-build-codeblocks/OpenIGTLink"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'git://github.com/openigtlink/OpenIGTLink.git'")
  endif()
